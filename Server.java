...
{    
  ...
  private JButton AddIP;
	...
	headlabl.setText("");
	headlab2.setText("CLOUD COMPUTING DATA STORAGE SECURITY");
	
	headlabl.setForeground(new Color(255, 0, 0 ));
    	headlabl.setBackground(new Color(255, 121, 255));
		headlabl.setFont(new Font("Times New Roman", 0, 20));
	...
	contentpane.add(headlabl,null);
		...
		headlab2.setFont(new Font("Times New Roman", 0, 20));
	...
	contentpane.add(headlab2,null);
        ...
        StartSer.setBackground(new Color(0, 232, 0));
        StartSer.setFont(new Font("Times New Roman", 0, 14));
        StartSer.setForeground(new Color(255, 255, 255));
        StartSer.setText("Start Server");
        StartSer.setBorder(new BevelBorder(3));
        StartSer.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent actionevent)
            {
                StartSerActionPerformed(actionevent);
                JOptionPane.showMessageDialog(StartSer, "server started",
...
///
        Startview.setBackground(new Color(0, 232, 0));
        Startview.setFont(new Font("Times New Roman", 0, 14));
...
//////////
        Startmobilealert.setBackground(new Color(0, 232, 0));
        Startmobilealert.setFont(new Font("Times New Roman", 0, 14));
        ...
        Startmobilealert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionevent)
            {
                ...
                JOptionPane.showMessageDialog(StartSer, "alert enabled",
                        "message", JOptionPane.INFORMATION_MESSAGE);
            }
        ...
        Adduser.setBackground(new Color(0, 232, 0));
        Adduser.setFont(new Font("Times New Roman", 0, 14));
...
///
        ...
        RemoveIP.setBackground(new Color(100, 160, 32));
        RemoveIP.setBorder(new EtchedBorder());
        jLabel1.setFont(new Font("Times New Roman", 0, 17));
		jLabel1.setForeground(new Color(255, 255, 255));
        jLabel1.setText(" IP Addresses:");
        ...
        AddIP.setFont(new Font("Times New Roman", 0, 14));
...
//new ip
        ...
        removeIP.setFont(new Font("Times New Roman", 0, 15));
...
////////////new addip
        addIP.setBackground(new Color(205, 205, 205));
        addIP.setFont(new Font("Times New Roman", 0, 15));
        addIP.setForeground(new Color(0, 0, 0));
...
////////////
        ...
        jPanel2.setBackground(new Color(100, 160, 32));
        jPanel2.setBorder(new EtchedBorder());
        jLabel2.setFont(new Font("Times New Roman", 0, 17));
        ...
        AddRes.setFont(new Font("Times New Roman", 0, 15));
        ...
        RemoveRes.setFont(new Font("Times New Roman", 0, 15));
...
//
    ...
    {	
    	...
    	if(jList2.isSelectionEmpty()){
    		JOptionPane.showMessageDialog(RemoveRes, "please select the file",
                    "message", JOptionPane.INFORMATION_MESSAGE);
    	}
	...
	rss();
    	...
    	/*
    	private JPanel NewResourcePanel=new JPanel();;
    	   private  JLabel jLabel7=new JLabel();
    	    private  JPanel jPanel3= new JPanel();
    	    private JLabel jLabel8=new JLabel();
    	    private JTextField filename=new JTextField(); 
    	    private JLabel jLabel9=new JLabel();
    	    private JTextField fakefilename=new JTextField(); ; 
...
public void add_rss(String f,String ff,String op,String allowedip)
{
        dbcon dbcon1 = new dbcon();
