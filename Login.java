    ...
    /** Creates new form Login */
	    ...
	    public Login()
	 {
	        ...
	        addWindowListener(new java.awt.event.WindowAdapter() 
		{
	        ...
	        jPan.setBackground(new java.awt.Color(0, 128, 0));
	        ...
	        exit.addActionListener(new java.awt.event.ActionListener() 
		{
	        ...
	        jLabel3.setText("Cloud Customer Login");
	        getContentPane().add(jLabel3);
	        jLabel3.setBounds(100, 10, 700, 30);
			JLabel imageLabel = new JLabel();
            ImageIcon ii = new ImageIcon(LoginDialog.class.getResource("images/administrator-icon.png"));
...
/////////change
	...
	JFrame jf1=new Login();
	 ...
	 jf1.setSize(900,600);
	 jf1.setTitle("Cloud Customer Login");
	jf1.show();
